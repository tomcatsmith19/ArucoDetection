...
ParamZero = [(-1*amplitude)/1000, (amplitude/1000), pulse_width, pulse_width, interphase_delay]; % set pattern parameters to 0 for layer choice (allows you to select what channels will be stimulated or not)
...
vtrans = (yzero_v + ymulty_v * (wf_v - yoff_v));
% Get time vector
